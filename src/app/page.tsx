          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
              ...
              <div className="relative">
                <button className="w-full px-3 py-2 text-left bg-white border border-gray-200 rounded-md text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500">
